            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <button 
                  ...
                  className="flex-1 bg-[#006a55] text-white h-12 rounded-xl font-bold hover:bg-[#005544] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#006a55]/20 active:scale-95"
                >
