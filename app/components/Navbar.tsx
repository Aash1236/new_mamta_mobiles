    ...
    async function fetchNavigation() {
      try {
        ...
        if (res.ok) {
          ...
          // Split data into two groups based on type
      ...
      <div className="w-full bg-white shadow-sm sticky top-0 z-50 font-sans">
        ...
        <div className="container mx-auto px-4 h-[88px] flex items-center justify-between relative">
          ...
          <div className="hidden lg:flex items-center gap-7 text-[13px] font-bold text-gray-600 tracking-wide uppercase h-full">
            <Link href="/" className="h-full flex items-center hover:text-[#006a55] border-b-4 border-transparent hover:border-[#006a55] transition-all">
              Home
            </Link>

            {/* --- DYNAMIC DEVICE MENU --- */}
            <div className="group h-full flex items-center cursor-pointer relative">
              <span className="group-hover:text-[#006a55] flex items-center gap-1">
                Device <ChevronDown className="w-3 h-3" />
              </span>
              {/* Mega Menu Dropdown */}
            ...
            <Link href="/warranty" className="h-full flex items-center hover:text-[#006a55] transition-colors">
              Warranty
            </Link>

            <Link href="/about" className="h-full flex items-center hover:text-[#006a55] transition-colors">
              About Us
            </Link>

            <Link href="/partner" className="h-full flex items-center hover:text-[#006a55] transition-colors">
              Partner With Us
            </Link>
          </div>
